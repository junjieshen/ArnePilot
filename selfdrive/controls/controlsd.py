...
class Controls:
  ...
  def state_control(self, CS):
    ...
    # Gas/Brake PID loop
    actuators.gas, actuators.brake = self.LoC.update(self.active, CS, v_acc_sol, long_plan.vTargetFuture, a_acc_sol, self.CP)#self.active, CS, v_acc_sol, long_plan.vTargetFuture, a_acc_sol, self.CP, long_plan.hasLead, self.sm['radarState'], long_plan.decelForTurn, long_plan.longitudinalPlanSource)
