...
class Controls:
  ...
  def state_control(self, CS):
    ...
    # Gas/Brake PID loop
    actuators.gas, actuators.brake = self.LoC.update(self.active, CS, v_acc_sol, long_plan.vTargetFuture, a_acc_sol, self.CP, long_plan.hasLead, self.sm['radarState'], long_plan.decelForTurn, LongitudinalPlan.longitudinalPlanSource)
  ...
  def publish_logs(self, CS, start_time, actuators, v_acc, a_acc, lac_log):
    ...
    controlsState.decelForTurn = self.sm['long_plan'].decelForTurn
    ...
    controlsState.decelForModel = self.sm['longitudinalPlan'].longitudinalPlanSource == LongitudinalPlanSource.modelV2
